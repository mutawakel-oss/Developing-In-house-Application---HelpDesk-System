<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmTechnicianDefault.aspx.cs" Inherits="frmTechnicianDefault" Title="Help Desk |Home page Technician" %>
...
<div id="body" style="width:1000px">
		...
		<asp:Table Width="100%" ID="Table2"  BackColor="#EBEBEB" runat="server">
	          <asp:TableRow>
		        <asp:TableCell>
		        <asp:ImageButton ID="hlkInventory" runat="server" ImageUrl="~/Images/Inventory.png" OnClick="mInventoryImageClicked" Width="190px" />
                 	</asp:TableCell>		        
		    </asp:TableRow>	          
		</asp:Table>
		</div>
			 ...
			 Task Summary
			  ...
			  <asp:TableRow  Height="40px" BackColor="#EBEBEB">
		        ...
		        <asp:TableCell VerticalAlign="Middle" HorizontalAlign="Left">
		            <asp:LinkButton id = "lbtnAssignedTasks" Text="Assigned Task"  Font-Size="Small" runat="server"  ForeColor="Black" Font-Underline="false" OnClick="DisplayTaskList"></asp:LinkButton>
		        </asp:TableCell>
