...
AutoEventWireup="true" CodeFile="frmManualRequest.aspx.cs" Inherits="frmNewRequest" Title="Help Desk | New Request Page" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<div  id="body"  style="width:1000px">
		...
		<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Images/Own_Requests.png" OnClick="mOwnRequestClick" Width="190px" />
		</asp:TableCell>
		</asp:TableRow>	
		<asp:TableRow runat="server">
		<asp:TableCell runat="server">		
		<asp:HyperLink ID="hlkAdminRequestList" runat="server" Text="All Requests" NavigateUrl="~/frmAdminRequestList.aspx" Font-Size="Smaller" Font-Bold="False" ForeColor="blue" Font-Underline="False" Enabled="False" Visible="False" meta:resourcekey="hlkAdminRequestListResource1"></asp:HyperLink>
		</asp:TableCell>
		</asp:TableRow>
		<asp:TableRow runat="server">
		<asp:TableCell runat="server">		
		<asp:HyperLink ID="hlkUserlist" runat="server" Text="User Management" NavigateUrl="~/frmLdapUsers.aspx" Font-Size="Smaller" Font-Bold="False" ForeColor="blue" Font-Underline="False" Enabled="False" Visible="False" meta:resourcekey="hlkUserlistResource1"></asp:HyperLink>
		</asp:TableCell>
		</asp:TableRow>		
		</asp:Table>
			</div>			
		...
		--%>
			...
			<asp:Label runat="server" ID="lblsubTit" Text="New Request" meta:resourcekey="lblsubTitResource1"></asp:Label>			
			 ...
			 <asp:TableRow>
			    <asp:TableCell>
			        <asp:Label ID="lblSearchRequestor" runat="server" Text="Enter User Name:"></asp:Label>
			    </asp:TableCell>
			    <asp:TableCell>
			        <asp:TextBox ID="txtUserNameSearch" runat="server" Width="183px"></asp:TextBox>
			         <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="mSearchUser" />
			    </asp:TableCell>
			    
			 </asp:TableRow>
		    <asp:TableRow runat="server">		        
		        <asp:TableCell Width="18%" runat="server">
		        <asp:Label ID="lbl5" runat="server" Text="Requestor" meta:resourcekey="lbl5Resource1"></asp:Label>		        
		        </asp:TableCell>
		        <asp:TableCell>
		        <asp:DropDownList ID="txtFullname" Width="250px" runat=server></asp:DropDownList>
		             </asp:TableCell>
		             ...
		             <asp:TableCell>
		             <asp:DropDownList ID="ddlCategory" runat="server" Width="215px"  ></asp:DropDownList> 
		             </asp:TableCell>
		 ...
		 <h2 runat="server" dir='<%$ Resources:MulResource, TextDirection %>' class="section">
		     ...
		     <asp:TableCell ID="TableCell6" Width="120px" runat="server">
		         ...
		         <asp:CheckBox ID="chbRequestedFor" runat="server" AutoPostBack="True" OnCheckedChanged="chbRequestedFor_OnCheckedChanged" Visible=false/>
		         </asp:TableCell>
		         <asp:TableCell ID="TableCell7" runat="server">
		         <asp:DropDownList ID="ddlRequestedFor" AutoPostBack="True" Width="253px" runat="server" >
		          </asp:DropDownList>
		         </asp:TableCell>		   
		        ...
		        <asp:TableCell runat="server">
		        <asp:DropDownList ID="ddlPriority" runat="server" Width="253px">
		        ...
		        <asp:TableRow>
		        <asp:TableCell>
		        <asp:Label ID="lblAssignDate" runat="server" Text="Assigningt Date" ></asp:Label>
		        </asp:TableCell>
		        <asp:TableCell>
		        <asp:TextBox ID="txtAssignDate" runat=server Width="60px"></asp:TextBox>
		        <asp:Image ID="imgAssignDt" runat="server"  ImageUrl="~/Images/date.gif"/>
	            <ajaxToolkit:CalendarExtender Format="MM/dd/yyyy" id="CalendarExtender1" runat="server" PopupButtonID="imgAssignDt" TargetControlID="txtAssignDate" BehaviorID="calAssignDate" Enabled="True"></ajaxToolkit:CalendarExtender>		
	            <asp:RequiredFieldValidator ID="assignDateValidator" runat=server ControlToValidate="txtAssignDate" ErrorMessage="*" ValidationGroup="requestGroup"></asp:RequiredFieldValidator>
	            Time
	            <asp:TextBox ID="txtAssignHours" runat=server Width="30px" MaxLength=2></asp:TextBox>	            
	            <asp:RequiredFieldValidator ID="assHoursValidator" runat=server ControlToValidate="txtAssignHours" ErrorMessage="*" ValidationGroup="requestGroup"></asp:RequiredFieldValidator>
	            <asp:TextBox ID="txtAssignMinutes" runat=server Width="30px" MaxLength=2></asp:TextBox>	            
	            <asp:RequiredFieldValidator ID="assignMinutesValidator" runat=server ControlToValidate="txtAssignMinutes" ErrorMessage="*" ValidationGroup="requestGroup"></asp:RequiredFieldValidator>
	            <asp:DropDownList ID="ddlAssignGlo" runat=server >
		        ...
		        <asp:TableCell>
		        <asp:Label ID="lblCompleteDate" runat="server" Text="Complete Date" ></asp:Label>
		        </asp:TableCell>
		        <asp:TableCell>
		        <asp:TextBox ID="txtCompleteDate" runat=server Width="60px"></asp:TextBox>
		        <asp:Image ID="imgCompleteDate" runat="server"  ImageUrl="~/Images/date.gif"/>
	            <ajaxToolkit:CalendarExtender Format="MM/dd/yyyy"  id="CalendarExtender2" runat="server" PopupButtonID="imgCompleteDate" TargetControlID="txtCompleteDate" BehaviorID="calEndDate" Enabled="True"></ajaxToolkit:CalendarExtender>		
	            <asp:RequiredFieldValidator ID="completeDateValidator" runat=server ControlToValidate="txtCompleteDate" ErrorMessage="*" ValidationGroup="requestGroup"></asp:RequiredFieldValidator>
	            Time
	            <asp:TextBox ID="txtCompleteHours" runat=server Width="30px" MaxLength=2></asp:TextBox>	            
	            <asp:RequiredFieldValidator ID="completeHoursValidator" runat=server ControlToValidate="txtCompleteHours" ErrorMessage="*" ValidationGroup="requestGroup"></asp:RequiredFieldValidator>
	            <asp:TextBox ID="txtCompleteMinutes" runat=server Width="30px" MaxLength=2></asp:TextBox>	            
	            <asp:RequiredFieldValidator ID="completeMinutesValidator" runat=server ControlToValidate="txtCompleteMinutes" ErrorMessage="*" ValidationGroup="requestGroup"></asp:RequiredFieldValidator>
	              <asp:DropDownList ID="ddlCompleteGlo" runat=server >
	            <asp:ListItem Selected=True >AM</asp:ListItem>
	            <asp:ListItem  >PM</asp:ListItem>
	            </asp:DropDownList>
		        </asp:TableCell>
         ...
         <asp:Button id="btnSave" OnClick="SaveNewRequest"  runat="server" Text="Send" meta:resourcekey="btnSaveResource1"  CausesValidation=true ValidationGroup="requestGroup" />
