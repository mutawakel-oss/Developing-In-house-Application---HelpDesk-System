<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmNewPcTech.aspx.cs" Inherits="frmNewPcTech" Title="Help Desk | New PC Tech" %>
...
<div id="body" style="width:1000px">
		...
		<%--<asp:TableRow>
		<asp:TableCell>		
		<asp:LinkButton ID="lbtNewRecipient" runat="server" Text="New Inv. Recipient" Font-Size="Smaller" Font-Bold="false"  Font-Overline="false" ForeColor="black" OnClick="AddNewSecretary"></asp:LinkButton>
	   </asp:TableCell>	   
	  </asp:TableRow>
